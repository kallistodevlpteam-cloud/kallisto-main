...
describe("ClientProjectDetailWorkspace", () => {
  ...
  it("renders project header, location, and title actions", () => {
    ...
    expect(screen.getByRole("link", { name: /task/i })).toHaveAttribute("href", "/client/projects/proj-nila-residence/tasks");
    expect(screen.getByRole("link", { name: /drive/i })).toHaveAttribute("href", "/client/projects/proj-nila-residence/documents");
    expect(screen.getByRole("link", { name: /boq/i })).toHaveAttribute("href", "/client/projects/proj-nila-residence/boq");
    expect(screen.getByRole("link", { name: /finance/i })).toHaveAttribute("href", "/client/projects/proj-nila-residence/finance");
    expect(screen.getByRole("link", { name: /site/i })).toHaveAttribute("href", "/client/projects/proj-nila-residence/site");
  });
