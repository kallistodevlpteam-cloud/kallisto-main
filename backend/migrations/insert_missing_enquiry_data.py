"""Insert missing related data for enquiry projects 16-19.
Tables already populated: client_details, project_site, project_budget, enquiry_details, project_clients, project_lifestyle, project_approval_process, project_communication
Tables missing: project_technical, project_regulatory, project_outdoor, project_timeline, project_spaces, requirements, family_details, inspiration_img, project_DOC, project_scope

Run from the backend directory:
    python migrations/insert_missing_enquiry_data.py
"""
...
def main() -> None:
    ...
    print(f"Inserting missing data for projects {project_ids}...")
    ...
    reg_data = [
        ...
        (17, "Commercial zone C-1, main road frontage", "Ground + 3 floors max (15m height)", "Commercial association fees Rs.5/sq ft/month", "Pending (architect to prepare drawings)", "None", "Front 5m, sides 3m, rear 3m"),
    ...
    # family_details (correct column order: family_id, client_id, description, created_at, updated_at, name, age, job, phone, relation, family_member_img_url)
    families_data = [
