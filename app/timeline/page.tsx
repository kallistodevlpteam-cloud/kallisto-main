...
import { ProjectTimelineWorkspace } from "@/features/projects/components/timeline/project-timeline-workspace";
    ...
    <AppShell>
      ...
      >
        <Suspense fallback={<div className="skeleton-card" style={{ height: "300px" }} />}>
          <ProjectTimelineWorkspace project={MOCK_NILA_PROJECT} />
        </Suspense>
      </RoutePageContainer>
    </AppShell>
  );
