...
export default async function ProjectTimelinePage({ params }: PageProps) {
  ...
  return (
    <AppShell>
      <Suspense
        fallback={
          <div className="workspace-container" style={{ padding: "24px" }}>
            <div className="route-state-box route-state-loading" aria-label="Loading project timeline workspace">
      ...
      >
        <ProjectModuleSubpage projectId={resolvedParams.projectId} module="timeline" />
      </Suspense>
    </AppShell>
  );
}
