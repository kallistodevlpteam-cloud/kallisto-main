  ...
  return (
    <div className={styles.authCanvas}>
      {/* =========================================================
          ...
          ========================================================= */}
      <section className={styles.brandingShell} aria-label="Kallisto Platform Overview">
        <div className={styles.brandingHero}>
          ...
          <h2 className={styles.brandingTitle}>
            ...
            <br />
            <span className={styles.brandingTitleSecondary}>The unified operating suite for project delivery.</span>
          </h2>
          <p className={styles.brandingDesc}>
            Empowering architects, interior designers, and contractors with structured requirements, site feasibility intelligence, authoritative BOQs, and transparent variation approvals.
          </p>
        </div>
      ...
      {/* =========================================================
          ...
          ========================================================= */}
      <section className={styles.loginShell} aria-label="Sign In">
          ...
          <div>
            <header className={styles.header}>
              ...
              <p className={styles.subtitle}>
                Manage projects, clients, feasibility, and construction workflows
              </p>
            </header>
